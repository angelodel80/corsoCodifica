...
\begin{frame}
  ...
  \begin{block}{Esempio edizione digitale image-based}
    ...
    \\\url{http://ebeowulf.uky.edu/}
  \end{block}
  
  \begin{center}
      \includegraphics[width=.7\textwidth]{imgs/eBeow.png}
  \end{center}
\end{frame}
...
\begin{frame}
  ...
  \end{block}
   ...
   \begin{center}
      \includegraphics[width=.7\textwidth]{imgs/vercelliDigitale.png}
  \end{center}
...
\begin{frame}
  ...
  \end{block}
   ...
   \begin{center}
      \includegraphics[width=.5\textwidth]{imgs/zoneBellini.png}
  \end{center}
