...
\begin{frame}
	...
	\textit{Un vocabolario XML è un insieme di tag XML implementato per una particolare esigenza di codifica}
...
\begin{frame}
	...
	\begin{block}{Cosa fa un XML parser}
		\begin{itemize}
			\item Verifica che il documento rispetti le rigole della sintassi XML
...
\begin{frame}
	...
	\begin{block}{XML body}
		Un documento XML è composto essenzialmente da elementi e attributi. 
...
\begin{frame}
	...
	\begin{block}{XML Element: note importanti sul nome}
		\begin{itemize}
			...
			\item Gli elementi possono iniziare con una lettere o con un undersore.
			\item Un elemento non può iniziare con la stringa \textit{xml}. 
			\item Il tag di apertura deve essere consistente con il relativo tag di chiusura.
			\item Un tag può essere usato più di una volta (anche a diversi livelli gerarchici).
			\item Un insieme di elementi formano un vocabolario (es.: vabolario TEI-XML)
		\end{itemize}
	\end{block}
\end{frame}
...
\begin{frame}
	...
	\begin{block}{XML Element: hierarchical relationship}
		\begin{itemize}
			...
			\item Il prologo e i commenti non fanno parte dell'albero del doby.
...
\begin{frame}
	...
	\begin{block}{XML Element: hierarchical relationship as tree structure}
		Un modo rapido e comodo per visualizzare la struttura completa di un documento XML è di disegnare attraverso un diagramma ad albero gli elementi del documento XML.
	\end{block}
