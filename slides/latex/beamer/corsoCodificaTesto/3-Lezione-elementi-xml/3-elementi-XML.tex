...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=.7\textwidth]{imgs/xml-markup001.jpg}
	\end{center}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[width=.8\textwidth]{imgs/xml-MarkupConvention.png}
	\end{center}
...
\input{includes/3-fondamenti-xml.tex}

\section{Validare un documento XML e Definire uno Schema}
\input{includes/3-elementi-schemi.tex}
