...
% Una tale forma di modellizzazione informatica di un documento testuale risulterebbe, peraltro, la più adeguata nel caso specifico dei manoscritti, per i quali nessuna descrizione di tipo linguistico sarebbe in grado di rappresentare tutte le informazioni visuali che una immagine digitale è in grado di veicolare.
...
%   Il computer può fornire una grande massa di analisi quantitative e statistiche: con la produzione di spogli lessicali, indici di frequenze, concordanze, attività che un elaboratore elettronico svolge con una efficienza di gran lunga superiore al più volenteroso studioso, e con una estensione pressoché illimitata.