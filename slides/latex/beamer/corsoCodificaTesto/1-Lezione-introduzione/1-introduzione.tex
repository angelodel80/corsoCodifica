...
%frame00 metadata
    \title{Presentazione del Corso Codifica di Testi aa 2018-2019}
...
\begin{frame}
	...
	\begin{block}{Modelli Object Oriented per il Textual Scholarlship}
...
\input{includes/1-intro.tex}

\section{Codifica dei Caratteri}
\input{includes/1-character-encoding.tex}

\section{Codifica dei Testi}
\input{includes/1-text-encoding.tex}

\section{Ecosistema XML}
\input{includes/1-xml-ecosystem.tex}

\section{Conclusioni}
\input{includes/1-conclusion.tex}

\section{Bibliografia}
\input{includes/1-biblio.tex}
