...
% Nella nostra cultura la quasi totalità dei testi è veicolata da documenti materiali fisici di varia natura e forma (manoscritti su pietra, pergamena, papiri, carta, libri a stampa, incunabula, cinquecentine, etc). Per rendere disponibile questo patrimonio attraverso i sistemi digitali e computazionali per la gestione dell’informazione è necessario effettuare una trasposizione/trascodifica dei testi (procedimento di conversione dei dati codificati secondo un sistema diverso) dal loro supporto originario al nuovo supporto elettronico.

% Slide con discorso generale sui temi trattati e sui moduli della TEI.