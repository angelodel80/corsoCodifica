...
\begin{frame}
    ...
    \begin{block}{Titolo, autore, curatore}
        ...
        \end{itemize} 
    \end{block}
    \textit{questi elementi possono contenere direttamente il testo con il nome oppure elementi più complessi (<persName> e sub-elementi)}
\end{frame}
...
\begin{frame}
	...
	\begin{block}{Componenti non testuali: immagini} 
       \begin{itemize}
           ...
           \item attributo \textbf{url} può essere locale o esterna
...
\begin{frame}
    ...
    \begin{block}{Componenti non testuali: immagini}
        \begin{itemize}
            \item <figure> raggruppa informazioni relative a un’immagine
            \item <head> titolo o didascalia relativa all’immagine
            \item <figDesc> descrizione dell'immagine
            \item <graphic> puntatore a un'immagine
        \end{itemize}
...
\begin{frame}
    ...
    \textit{Nella TEI P4 è indispensabile inserire dichiarazioni
	...
	\begin{block}{Esempio TEI P4}
        ...
        \texttt{<?xml version='1.0' encoding='utf-8'?>
        ...
        \underline{<!NOTATION JPEG PUBLIC
